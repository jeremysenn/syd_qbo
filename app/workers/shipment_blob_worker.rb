class ShipmentBlobWorker
  ...
  def perform(shipment_file_id)
    ...
    shipment = Shipment.create(:file_name => File.basename(shipment_file.file_url), :branch_code => shipment_file.branch_code, :location => shipment_file.location, :ticket_nbr => shipment_file.ticket_number,
