class SendBillPaymentToLeadsWorker
  include Sidekiq::Worker
  
  def perform(access_token, access_secret, path_to_file, bill_payment_id, bill_id, current_company_id, user_id, customer_id)
    require 'net/ftp'
    ...
    File.open(path_to_file, 'w') {|f| f.write(BillPayment.generate_xml(bill_payment, bill, company_info, current_company_id, user, customer, item_service, images)) }
